...
* Um festzustellen, zu welchen Zugriffsgruppen Sie gehören, wählen Sie **Zugriffsgruppen** aus.
...
Sie müssen die Administratorrolle für den Service oder die Ressource innehaben, zu dem bzw. der Sie Benutzern Zugriff gewähren möchten. Wenn Sie den Zugriff auf alle Services oder Ressourcen im Konto zuordnen möchten, benötigen Sie eine Richtlinie für alle IAM-fähigen Services mit der Administratorrolle. 
...
Der Kontoeigner kann Benutzer jederzeit hinzufügen oder entfernen. Außerdem kann jeder Benutzer mit einer der beiden folgenden Richtlinientypen Benutzer entfernen:

* Bearbeiter oder Administrator für alle Kontoverwaltungsservices
* Bearbeiter oder Administrator für den Benutzerverwaltungs- und Kontoverwaltungsservice
...
## Wie weise ich einen Benutzer als Kontoadministrator zu? 
{: #account-administrator}

Zum Delegieren der Kontoadministratorrolle mithilfe von IAM-Richtlinien müssen Sie zwei Richtlinien erstellen:

* Administrator für alle Services mit aktiviertem Identity and Access Management, wodurch der Benutzer die Möglichkeit erhält, Serviceinstanzen zu erstellen und Benutzern Zugriff auf alle Ressourcen im Konto zu erteilen.
* Administrator für alle Kontoverwaltungsservices, wodurch der Benutzer die Möglichkeit erhält, Tasks wie das Einladen und Entfernen von Benutzern, Verwalten von Zugriffsgruppen, Service-IDs und privaten Katalogangeboten sowie die Abrechnungs- und Nutzungsverfolgung auszuführen.

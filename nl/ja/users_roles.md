...
アカウント内のリソース・グループに編成されたすべてのサービスは、{{site.data.keyword.Bluemix_notm}}  Identity and Access Management (IAM) を使用して管理されます。 アカウント所有者には、Cloud IAM に対するアカウント管理者役割が自動的に割り当てられます。 アカウント管理者は、Cloud IAM 役割を割り当てることによって、ユーザーのアクセス権限の割り当てと管理、リソース・グループの作成、およびサービス・インスタンスのプロビジョンを実行できます。 ポリシーを作成することによって、ユーザーおよびサービス ID のアクセス権限を指定します。ポリシーは、ユーザーまたはサービス ID がアクセスできるターゲットと、どのタイプのアクセスが許可されるのかを定義する役割を設定します。
...
|:-----------------|:--------------|:---------------|:----------------|:-----------------|:--------------|
| *サービス* | 選択された 1 つまたはすべての IAM 対応サービス | 選択された IAM Identity サービス | 選択されたリソース・グループ | リソース・グループ内の選択されたサービス | 選択された IAM アクセス・グループ |

...
コンソールで提供されている役割の説明に加えて、以下の表に、各役割を割り当てられたユーザーが、{{site.data.keyword.containershort_notm}} サービスで実行できる可能性のあるいくつかのタスクの例を示します。  

| 役割| アクションの説明| アクションの例|
|:-----------------|:-----------------|:-----------------|
| ビューアー| 状態を変更しないアクション (読み取り専用アクション) を実行します| <ul><li>クラスターのリスト</li><li>クラスターの詳細を表示する</li></ul>|
| エディター| 状態を変更し、サブリソースを作成または削除するアクションを実行します|<ul><li>クラスターへのサービスのバインド</li><li>Web フックの作成</li></ul> |

...
계정 소유자는 항상 사용자를 추가 및 제거할 수 있습니다. 또한 다음 두 정책 유형의 사용자는 사용자를 제거할 수 있습니다.

* 모든 계정 관리 서비스에서 편집자 또는 관리자
* 사용자 관리 계정 관리 서비스의 편집자 또는 관리자
...
## 계정 관리자로 사용자를 어떻게 지정합니까? 
{: #account-administrator}

IAM 정책을 사용하여 계정 관리자 역할을 위임하려면 다음 두 정책을 작성해야 합니다.

* 모든 ID 및 액세스 사용 서비스의 관리자: 이를 통해 서비스 인스턴스를 작성하고 계정의 모든 리소스에 대한 액세스 권한을 사용자에게 지정할 수 있음
* 모든 계정 관리 서비스의 관리자: 이를 통해 사용자는 사용자 초대 및 제거, 액세스 그룹 관리, 서비스 ID 관리, 사설 카탈로그 오퍼링 관리, 청구 및 사용량 추적과 같은 태스크를 완료할 수 있습니다.

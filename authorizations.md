...
You can grant only the level of access that you have as a user of the target service. For example, if you have only viewer access on the service that is going to be accessed, then you can assign only the viewer role for the authorization.
...
4. Select a role to assign access to the source service when it accesses the target service.
5. Click **Authorize**.
